...
export const CredSpecialPlan = (): JSX.Element => {
  ...
  return (
    <main className="bg-white overflow-hidden w-full max-w-[420px] min-w-[360px] min-h-[800px] relative mx-auto">
      <div className="absolute top-[335px] left-1/2 -translate-x-1/2 w-[100%] h-[476px] bg-[#FF9B031A] rounded-[24px_24px_0px_0px]" />

      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[100%] h-[200px] bg-[linear-gradient(180deg,rgba(52,190,134,0.3)_0%,rgba(52,190,134,0)_100%)]" />

      <h1 className="absolute left-1/2 -translate-x-1/2 bottom-[566px] w-[294px] [font-family:'Figtree',Helvetica] font-bold text-primary-coloursc1 text-[28px] text-center tracking-[0] leading-[30px]">
        Your 1 month Free Trial has been activated
      </h1>

      <div className="absolute left-1/2 -translate-x-1/2 bottom-[646px] w-14 h-14 bg-brand-coloursgreen rounded-full flex items-center justify-center">
        <img src={success} alt="" />
      </div>

      <p className="absolute top-[246px] left-1/2 -translate-x-1/2 w-80 [font-family:'Figtree',Helvetica] font-normal text-c-2 text-sm text-center tracking-[0] leading-5">
      ...
      <section className="absolute top-[434px] left-1/2 -translate-x-1/2 w-80 h-[270px]">
      ...
      <h2 className="absolute top-[361px] left-1/2 -translate-x-1/2 w-[320px] [font-family:'Figtree',Helvetica] font-bold text-[#0a1f34] text-2xl text-center tracking-[0] leading-7">
        <span className="block">Download the our app</span>
        <span className="block">&amp; start your fitness journey</span>
      </h2>

      <div className="absolute top-[724px] left-1/2 -translate-x-1/2 flex items-center justify-center gap-3">
        <Button
          variant="default"
          className="w-[155px] h-[50px] bg-black hover:bg-black/90 rounded-[7.23px] p-0"
        >
